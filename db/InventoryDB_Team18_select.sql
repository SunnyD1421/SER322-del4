...
/* Select the names of all employees who work at Phoenix branch and who have
...
/* Select the phone number of the Flagstaff location */
SELECT PhoneNumber
FROM LOCATION 
...
/* Select names of all products from Tempe that are currently in stock */
SELECT P.Name
